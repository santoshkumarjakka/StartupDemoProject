...
import com.example.demo.my_interface.OnRangeSeekbarChangeListener;
...
public class RangeSeekbar extends View {
    ...
    public RangeSeekbar setBarHeight(float height) {
        _barHeight = height;
        return this;
    }

    public RangeSeekbar setBarColorMode(int barColorMode) {
    ...
    public RangeSeekbar setBarGradientStart(int barGradientStart) {
        this.barGradientStart = barGradientStart;
        return this;
    }

    public RangeSeekbar setBarGradientEnd(int barGradientEnd) {
        this.barGradientEnd = barGradientEnd;
        return this;
    }

    public RangeSeekbar setBarHighlightColorMode(int barHighlightColorMode) {
    ...
    public RangeSeekbar setBarHighlightGradientStart(int barHighlightGradientStart) {
        this.barHighlightGradientStart = barHighlightGradientStart;
        return this;
    }

    public RangeSeekbar setBarHighlightGradientEnd(int barHighlightGradientEnd) {
    ...
    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.RangeSeekbar_bar_color_mode, CustomSeekbar.ColorMode.SOLID);
    }
    ...
    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_bar_gradient_start, Color.GRAY);
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_bar_gradient_end, Color.DKGRAY);
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.RangeSeekbar_bar_highlight_color_mode, CustomSeekbar.ColorMode.SOLID);
    }
    ...
    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_bar_highlight_gradient_start, Color.DKGRAY);
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.RangeSeekbar_bar_highlight_gradient_end, Color.BLACK);
    }
    ...
    protected void setupBar(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        if (barColorMode == CustomSeekbar.ColorMode.SOLID) {
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        if (barHighlightColorMode == CustomSeekbar.ColorMode.SOLID) {
